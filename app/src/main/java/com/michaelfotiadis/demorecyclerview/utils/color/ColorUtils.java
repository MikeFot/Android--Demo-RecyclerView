package com.michaelfotiadis.demorecyclerview.utils.color;
...
public final class ColorUtils {
    ...
    public static String getColorNameFromHex(final String hex) {

        if (hex == null || hex.length() != 6) {
            return "";
        } else {
            final int color = (int) Long.parseLong(hex, 16);
            return getColorNameFromHex(color);
        }
    }
     ...
     */
    public static String getColorNameFromHex(final int hexColor) {
     ...
     */
    public static String getColorNameFromRgb(final int red, final int green, final int blue) {
        final ArrayList<ColorName> colorList = initColorList();
